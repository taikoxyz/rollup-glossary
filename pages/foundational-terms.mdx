...
A ZK-Rollup that can interpret and execute Ethereum bytecode. All Ethereum opcodes are supported.
...
Uncompromisingly Ethereum-equivalent. Able to prove the correctness of an Ethereum block in its ZK-EVM circuit. No changes made to any part of Ethereum--EVM and beyond. 

## EVM-equivalent ZK-EVM

A ZK-Rollup that can interpret and execute Ethereum bytecode. All Ethereum opcodes are supported and Ethereum smart contracts can almost always run as is. 
