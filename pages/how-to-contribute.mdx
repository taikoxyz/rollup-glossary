...
```
## <bank>
<just like a bank issue an account number and authorised people can deposit, withdraw ,overdraw within that account, in the same way a bridge is used to commit funds and withdraw funds on the otherside>
```
